...
!function(t, e) {
    ...
    var r, a, l, c, u = function(t) {
        ...
        Object.keys(n).forEach((function(i) {
            var o, s = n[i], r = e[i], a = r && m(r) ? "element" : null == (o = r) ? "" + o : {}.toString.call(o).match(/\s([a-z]+)/i)[1].toLowerCase();
            if (!new RegExp(s).test(a))
                throw new Error(t.toUpperCase() + ': Option "' + i + '" provided type "' + a + '" but expected type "' + s + '".')
        }
        ))
    }, b = function(t) {
        if (!t)
    ...
    a = 1,
    {
        ...
        k.delete(t, e)
    }, A = Element.prototype.querySelectorAll, S = Element.prototype.querySelector, O = (l = new CustomEvent("Bootstrap",{
        cancelable: !0
    }),
                    ...
                    return function i(o) {
                        for (var s = t.querySelectorAll(e), r = o.target; r && r !== this; r = r.parentNode)
                            for (var a = s.length; a--; )
                                if (s[a] === r)
                                    return i.oneOff && q.off(t, o.type, n),
                                    n.apply(r, [o]);
                        return null
                    }
                }(t, n, i) : function(t, e) {
                    return function n(i) {
                        return n.oneOff && q.off(t, i.type, e),
                        e.apply(t, [i])
                    }
                }(t, n);
    ...
    var q = {
        ...
        trigger: function(t, e, n) {
            ...
            return s && I && (i = I.Event(e, n),
            I(t).trigger(i),
            a = !i.isPropagationStopped(),
            l = !i.isImmediatePropagationStopped(),
            c = i.isDefaultPrevented()),
            r ? (u = document.createEvent("HTMLEvents")).initEvent(o, a, !0) : u = new CustomEvent(e,{
                bubbles: a,
                cancelable: !0
            }),
            ...
            c && (u.preventDefault(),
            O || Object.defineProperty(u, "defaultPrevented", {
                get: function() {
                    return !0
                }
            })),
      ...
      , K = function() {
        function t(t) {
            this._element = t,
            this._element && T(t, "bs.alert", this)
        }
        var e = t.prototype;
    ...
    var et = {
      ...
      , lt = function() {
        ...
        e.pause = function(t) {
            t || (this._isPaused = !0),
            nt.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (p(this._element),
            this.cycle(!0)),
        ...
        e._slide = function(t, e) {
            var n, i, o, s = this, r = nt.findOne(".active.carousel-item", this._element), a = this._getItemIndex(r), l = e || r && this._getItemByDirection(t, r), c = this._getItemIndex(l), u = Boolean(this._interval);
    ...
    var ht = "collapse"
      ...
      , gt = function() {
        function t(t, e) {
            ...
            this._element = t,
            this._config = this._getConfig(e),
            this._triggerArray = nt.find('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]');
            for (var n = nt.find('[data-toggle="collapse"]'), i = 0, o = n.length; i < o; i++) {
                ...
                null !== r && a.length && (this._selector = r,
        ...
        e.show = function() {
            ...
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                ...
                if (n) {
                    ...
                    if ((i = s[0] ? L(s[0], "bs.collapse") : null) && i._isTransitioning)
                        return
                }
        ...
        ,
        e._getConfig = function(t) {
            return (t = s(s({}, ft), t)).toggle = Boolean(t.toggle),
            v(ht, t, dt),
            t
        }
        ,
      ...
      , wt = function() {
            ...
            if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                ...
                if (!q.trigger(this._element, "show.bs.dropdown", i).defaultPrevented) {
                    if (!this._inNavbar) {
                        ...
                        var o = this._element;
                        "parent" === this._config.reference ? o = n : m(this._config.reference) && (o = this._config.reference,
        ...
        i.hide = function() {
            if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
                ...
                q.trigger(t, "hide.bs.dropdown", n).defaultPrevented || (this._popper && this._popper.destroy(),
                et.toggleClass(this._menu, "show"),
                et.toggleClass(this._element, "show"),
        ...
        i._getConfig = function(t) {
            return t = s(s(s({}, this.constructor.Default), et.getDataAttributes(this._element)), t),
        ...
        i._getPlacement = function() {
            var t = this._element.parentNode
              , e = "bottom-start";
            return t.classList.contains("dropup") ? (e = "top-start",
            this._menu.classList.contains("dropdown-menu-right") && (e = "top-end")) : t.classList.contains("dropright") ? e = "right-start" : t.classList.contains("dropleft") ? e = "left-start" : this._menu.classList.contains("dropdown-menu-right") && (e = "bottom-end"),
            e
        }
        ,
        ...
        e.dataApiKeydownHandler = function(t) {
            if (!(/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu")) : !vt.test(t.key)) && (t.preventDefault(),
            t.stopPropagation(),
            !this.disabled && !this.classList.contains("disabled"))) {
                var n = e.getParentFromElement(this)
                  , i = this.classList.contains("show");
                if ("Escape" === t.key)
                    return (this.matches('[data-toggle="dropdown"]') ? this : nt.prev(this, '[data-toggle="dropdown"]')[0]).focus(),
                    void e.clearMenus();
                if (i && "Space" !== t.key) {
    ...
    var Tt = {
      ...
      , Ct = function() {
        ...
        e.hide = function(t) {
            ...
            this._isShown && !this._isTransitioning) && !q.trigger(this._element, "hide.bs.modal").defaultPrevented) {
                this._isShown = !1;
        ...
        e._resetScrollbar = function() {
            nt.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(t) {
                ...
                void 0 !== e && (et.removeDataAttribute(t, "padding-right"),
                t.style.paddingRight = e)
            }
            )),
            nt.find(".sticky-top").forEach((function(t) {
                var e = et.getDataAttribute(t, "margin-right");
                void 0 !== e && (et.removeDataAttribute(t, "margin-right"),
                t.style.marginRight = e)
            }
            ));
            var t = et.getDataAttribute(document.body, "padding-right");
            void 0 === t ? document.body.style.paddingRight = "" : (et.removeDataAttribute(document.body, "padding-right"),
        ...
        for (var o = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(e), r = (i = []).concat.apply(i, o.body.querySelectorAll("*")), a = function(t, n) {
            ...
            l.forEach((function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === Ot.indexOf(n) || Boolean(t.nodeValue.match(Dt) || t.nodeValue.match(It));
      ...
      , Ut = function() {
            ...
            if (this._isEnabled)
                if (t) {
                    var e = this.constructor.DATA_KEY
                      , n = L(t.target, e);
                    n || (n = new this.constructor(t.target,this._getDelegateConfig()),
                    T(t.target, e, n)),
        ...
        i.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                if (T(s, this.constructor.DATA_KEY, this),
                ...
                if (this.tip.classList.contains("fade")) {
                    var d = g(this.tip);
                    q.one(this.tip, "transitionend", f),
                    _(this.tip, d)
                } else
                    f()
            }
        ...
        i.setElementContent = function(t, e) {
            if (null !== t)
                return "object" == typeof e && m(e) ? (e.jquery && (e = e[0]),
                void (this.config.html ? e.parentNode !== t && (t.innerHTML = "",
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = jt(e, this.config.whiteList, this.config.sanitizeFn)),
        ...
        i._enter = function(t, e) {
            ...
            (e = e || L(t.target, n)) || (e = new this.constructor(t.target,this._getDelegateConfig()),
            T(t.target, n, e)),
        ...
        i._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (t.classList.remove("fade"),
    ...
    var Zt = "scrollspy"
      ...
      , ee = function() {
        ...
        return e.refresh = function() {
            ...
            nt.find(this._selector).map((function(t) {
                var e, o = f(t);
                if (o && (e = nt.findOne(o)),
                e) {
        ...
        e._activate = function(t) {
            ...
            var e = this._selector.split(",").map((function(e) {
              ...
              , n = nt.findOne(e.join(","));
            n.classList.contains("dropdown-item") ? (nt.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"),
    ...
    var oe = function() {
        ...
        e._transitionComplete = function(t, e, n) {
            ...
            t.parentNode && t.parentNode.classList.contains("dropdown-menu")) && (t.closest(".dropdown") && nt.find(".dropdown-toggle").forEach((function(t) {
                return t.classList.add("active")
            }
            )),
            t.setAttribute("aria-expanded", !0));
    ...
    q.on(document, "click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(t) {
        t.preventDefault(),
        (L(this, "bs.tab") || new oe(this)).show()
    }
    ));
    var se = E();
    if (se) {
    ...
    var ae = {
      ...
      , ce = function() {
        ...
        ,
        e._getConfig = function(t) {
            return t = s(s(s({}, le), et.getDataAttributes(this._element)), "object" == typeof t && t ? t : {}),
